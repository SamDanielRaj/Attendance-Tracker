...
<head>
  ...
  <link href="img/logo/attnlogo.png" rel="icon">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="classArmName" value="<?php echo $row['classArmName'];?>" id="exampleInputFirstName" placeholder="Section">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
